...
class SoundDeviceAudioDetector:
    """使用SoundDevice的音频检测器"""
    ...
    def __init__(self):
        ...
        self.logger.info("SoundDevice音频检测器初始化完成")
    ...
    def _setup_logging(self):
        ...
        # 创建logger
        self.logger = logging.getLogger('SoundDeviceDetector')
...
def main():
    ...
    try:
        # 创建检测器
        detector = SoundDeviceAudioDetector()
